...
extern __attribute__ ((section(".entry"), noreturn)) void em__start() {
...
extern __attribute__ ((section(".entry"))) void* memcpy(void* dst, const void* src, size_t n) {
